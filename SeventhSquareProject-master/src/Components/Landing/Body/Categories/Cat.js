...
function Cat(props) {
  ...
  return (props.product.map((curr, index) => {
    return (
      ...
      <CatItem sellerId={curr.account} name={curr.name} price={curr.sellingPrice} key={index} id={curr.id} oldp={curr.markedPrice} gst={curr.gstRate} handleapply={props.handleapply} />
