...
function SanitarywareFilter(props) {
    return (
                 ...
                 <h6 class="font-weight-bold mb-3">Material</h6>
                    <div class="form-check pl-0 mb-3">
                        <input
                          ...
                          class="form-check-input filled-in"
                          id="Plastic"
                          onChange={()=>props.handlesanitarymaterial('Plastic')}
                        />
                        <label
                          class="form-check-label small text-uppercase card-link-secondary"
                          for="Plastic"
                      ...
                      <div class="form-check pl-0 mb-3">
                        <input
                          ...
                          class="form-check-input filled-in"
                          id="Steel"
                          onChange={()=>props.handlesanitarymaterial('Steel')}
                        />
                        <label
                          class="form-check-label small text-uppercase card-link-secondary"
                          for="Steel"
                      ...
                      <div class="form-check pl-0 mb-3">
                        <input
                          ...
                          class="form-check-input filled-in"
                          id="Ceramic"
                          onChange={()=>props.handlesanitarymaterial('Ceramic')}
                        />
                        <label
                          class="form-check-label small text-uppercase card-link-secondary"
                          for="Ceramic"
...
export default SanitarywareFilter
